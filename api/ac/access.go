...
/*
DefaultAccessDB is the default access table for FishDB
*/
var DefaultAccessDB = []byte(`
/*
Access control file for FishDB. This file controls the access rights for each user.
...
*/
{
  ...
  "users": {
    "elias": [    // Default FishDB admin user
      "public",
      "admin"
    ],
	"johndoe" : [ // Default FishDB public user
	  "public"
	]
  }
}
