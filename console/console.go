...
func NewConsole(url string, out io.Writer, getCredentials func() (string, string),
	...
	c := &FishDBConsole{url, "main", out, bytes.NewBuffer(nil), nil,
...
/*
FishDBConsole implements the basic console functionality like login and version.
*/
type FishDBConsole struct {
...
*/
func (c *FishDBConsole) URL() string {
	return c.url
}
...
Out returns a writer which can be used to write to the console.
*/
func (c *FishDBConsole) Out() io.Writer {
	return c.out
}
...
Partition returns the current partition.
*/
func (c *FishDBConsole) Partition() string {
	return c.part
}
...
*/
func (c *FishDBConsole) SetPartition(part string) {
	c.part = part
}
...
AskPassword asks the user for a password.
*/
func (c *FishDBConsole) AskPassword() string {
...
ExportBuffer returns a buffer which can be used to write exportable data.
*/
func (c *FishDBConsole) ExportBuffer() *bytes.Buffer {
	return c.export
}
...
had an unexpected result and a flag if the command was handled.
*/
func (c *FishDBConsole) Run(cmd string) (bool, error) {
...
*/
func (c *FishDBConsole) RunCommand(cmdString string) (bool, error) {
...
Commands returns a sorted list of all available commands.
*/
func (c *FishDBConsole) Commands() []Command {
	var res []Command
...
Authenticate authenticates the user if necessary.
*/
func (c *FishDBConsole) Authenticate(force bool) {
...
Req is a convenience function to send common requests.
*/
func (c *FishDBConsole) Req(endpoint string, method string, content []byte) (interface{}, error) {
	var res interface{}
...
request to the server is being made.
*/
func (c *FishDBConsole) SendRequest(endpoint string, contentType string, method string,
	content []byte, reqMod func(*http.Request)) (string, *http.Response, error) {
