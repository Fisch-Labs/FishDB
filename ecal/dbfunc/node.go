...
/*
StoreNodeFunc inserts a node in FishDB.
*/
...
func (f *StoreNodeFunc) DocString() (string, error) {
	return "Inserts a node in FishDB.", nil
}

/*
UpdateNodeFunc updates a node in FishDB (only update the given values of the node).
*/
...
func (f *UpdateNodeFunc) DocString() (string, error) {
	return "Updates a node in FishDB (only update the given values of the node).", nil
}

/*
RemoveNodeFunc removes a node in FishDB.
*/
...
func (f *RemoveNodeFunc) DocString() (string, error) {
	return "Removes a node in FishDB.", nil
}

/*
FetchNodeFunc fetches a node in FishDB.
*/
...
func (f *FetchNodeFunc) DocString() (string, error) {
	return "Fetches a node in FishDB.", nil
}
